    ...
    <div name="about" className="w-full h-full flex-wrap  object-contain">
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        <p className="text-lg mt-20">
          I am Manasa Mohapatra, a Btech undergraduate in the department of
          Electrical Engineering. But I have a keen interest in software
          developement. Currently I am learning DSA along with full stack web
          developement.I also have interest in app developement. In the future I
          want to explore different domains and grasp more knowledge about it.
        </p>
        ...
        <div class="container mt-4 mx-auto z-0">
          <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 z-0">
            <div class="card m-2 cursor-pointer border border-gray-400 rounded-lg hover:shadow-md hover:border-opacity-0 transform hover:-translate-y-1 transition-all duration-200">
              <div class="m-3">
                ...
                <p class="font-light font-mono text-sm text-gray-300 hover:text-gray-600 transition-all duration-200">
                  Grade:91.3%
                  <br />
